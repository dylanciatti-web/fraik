...
2. ~~Laisser uniquement AD02 tester...~~ **Traitée (13/07 soir) :** palier atteint, 0 ATC confirmé, Dylan a coupé la campagne. **Test final 15 € relancé (13/07 soir) avec la créa V8** — voir État actuel. Prochaine étape : vérifier `list-orders` + ATC/InitiateCheckout du dataset FRAÎK une fois le palier atteint, et appliquer la règle de décision déjà actée.
